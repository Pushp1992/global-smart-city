...
const clients = [
  {
    ...
    grant proposals or attractive funds-seeking proposals tailored to meet diverse funders’ guidelines. As per the mandates of several ministries,
  ...
  },
  {
    ...
    authorities. B2B is the flourishing industry, we always work integrally with diverse partners or Multi National Companies in multiple 
    sectors to support their clients or transformation mission. Our team is highly experienced and dedicated to support the requirements. 
    As we are growing and reaching to more industries with great demands, as this has been the ask in the current situation which we are going
    through.`,
  },
  {
    id: 5,
    ...
    professional courses through seminars and workshops at the workplace. As we strongly believe in helping our partner to flourish nd expand
