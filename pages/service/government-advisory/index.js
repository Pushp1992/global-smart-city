...
import { Advisory } from "../../../src/utils/MenuItems/Services/advisory";
    ...
    <React.Fragment>
      <Container disableGutters={true} maxWidth="false">
        ...
        <Grid item md style={style.margin}>
          ...
          >
            {Advisory.firstSection.description}
          </Typography>
        </Grid>
      </Container>
              ...
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {Advisory.secondSection.title}
                  </Typography>
                  <Typography>{Advisory.secondSection.description}</Typography>
                </TimelineContent>
              </TimelineItem>{" "}
              <br />
              <br />
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {Advisory.thirdSection.title}
                  </Typography>
                  <Typography>
                    <ul style={style.marginLeft}>
                      {Advisory.thirdSection.description.map((item) => {
