...
import { Consulting } from "../../../src/utils/MenuItems/Services/consulting";
    ...
    <React.Fragment>
      <Container disableGutters={true} maxWidth="false">
        ...
        <Grid item md style={style.margin}>
          ...
          >
            {Consulting.firstSection.description}
          </Typography>
        </Grid>
      </Container>
              ...
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {Consulting.secondSection.title}
                  </Typography>
                  <Typography>{Consulting.secondSection.description}</Typography>
                </TimelineContent>
              </TimelineItem>{" "}
              <br />
              <br />
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {Consulting.thirdSection.title}
                  </Typography>
                  <Typography>
                    <ul style={style.marginLeft}>
                      {Consulting.thirdSection.description.map((item) => {
