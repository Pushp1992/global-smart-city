...
import { BenchMarking } from "../../../src/utils/MenuItems/Services/city-benchmarking";
    ...
    <React.Fragment>
      <Container disableGutters={true} maxWidth="false">
        ...
        <Grid item md style={style.margin}>
          ...
          >
            {BenchMarking.firstSection.title}
          </Typography>
          <Typography
            align="left"
            display="initial"
          ...
          >
            {BenchMarking.firstSection.description}
          </Typography>
        </Grid>
      </Container>
              ...
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {BenchMarking.secondSection.title}
                  </Typography>
                  <Typography>
                    {BenchMarking.secondSection.description}
                  </Typography>
                </TimelineContent>
              </TimelineItem>{" "}
              <br />
              ...
              <TimelineItem className="customStyle">
                ...
                <TimelineContent>
                  <Typography
                    ...
                    style={style.headingTextColor}
                  >
                    {BenchMarking.thirdSection.title}
                  </Typography>
                  <Typography>
                    <ul style={style.marginLeft}>
                      {BenchMarking.thirdSection.description.map((item) => {
...
export default SmartCityBenchMarking;
